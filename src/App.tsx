...
function AppContent() {
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-black text-zinc-300 font-sans antialiased overflow-x-hidden">
      ...
      <div className="hidden md:block w-80 shrink-0 sticky top-0 h-screen overflow-hidden">
        <Sidebar />
      </div>
      ...
      <main className="flex-1 min-h-[calc(100vh-73px)] md:min-h-screen flex flex-col justify-between">
